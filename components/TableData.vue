    ...
    <div class="row ml-3 mr-3">
      <div class="col-md-10">
        <slot name="table-data-filters">
          <b-form
            v-if="(!disableFilters && filters.length > 0) || (!disableFilters && items.length > 0)"
            class="row" inline
          >
            <b-input-group v-for="(filter, i) in filters" :key="i" class="filter-input-group col-md-3 col-sm-6 mb-3">
              ...
              <b-input
                v-model="filter.value" id="inline-form-input-name"
              ...
              <b-input-group-append>
                <b-btn
                  ...
                  @click="evt => {
                    filters = filters.filter(f => f.index !== filter.index);
      ...
      <b-dropdown
        ...
        <b-dropdown-form>
          <b-form-checkbox v-model="allSelected" @change="toggleAll">
            {{
              allSelected ?
                $t('components.table_data.desmarcar_todas') :
