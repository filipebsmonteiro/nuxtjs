    ...
    <div class="container-fluid border w-75 rounded-20 overflow-hidden mt-4 mb-5 shadow">
      ...
      <b-row>
        <b-col cols="3">
          ...
          <div class="bg-secondary mt--3 pt-4 pl-2 pr-2 pb-5">
            <div class="d-flex justify-content-center mt-4">
              <h3 style="text-shadow: 0px 3px 4px rgba(0, 0, 0, 0.3);font-family:Malvie;">
                Emprego Atual
              </h3>
            </div>
            <b-card
              class="rounded-20 border-bottom-larger pl-3 pr-3 pt-1 pb-1 d-flex flex-row justify-content-around align-items-center"
              no-body
            >
              <span class="d-table">
              ...
              <div>
                <h4 class="text-secondary mb-0" style="font-family:Malvie;">
                  Veus Techonology
                </h4>
                <p class="mb-0">
                  2020 - Atual
        ...
        <b-col cols="9">
          <div class="d-flex justify-content-around mt-5 mb-3 pt-5 pb-4">
            <IconText icon="calendar-alt" icon-padding="2" text="25 de Fev." title />
            <IconText icon="map-marker-alt" icon-padding="2" text="Rio de Janeiro - BR" title />
            <IconText icon="graduation-cap" icon-padding="2" text="Faculdade Projeção" title />
            <div class="d-flex">
              <a
                href="https://linkedin.com/in/filipebsmonteiro"
                class="d-flex p-2 text-white border border-white rounded-pill"
              >
          ...
          <b-row>
            <b-col cols="8">
              <b-card class="rounded-20 overflow-hidden" no-body>
                <b-card-header>
                  <IconText
                    icon-padding="2"
                    icon-border-color="0"
                ...
                <p class="p-3">
                  Possuo mais de 7 anos de experiência como programador PHP, trabalho atualmente como
                  desenvolvedor PHP Fullstack e uso PHP, Docker, VueJS , Bootstrap, Linux, diversos bancos de dados,
                  utilizo TDD, BDD, SOLID, PSR e tenho aprofundado os meus conhecimentos em arquitetura de softwares e
                  componentização. Também tenho experiência em integrações com API's de marketing da Google e
                  Facebook.
                </p>
              </b-card>
            </b-col>
...
.background-main {
  ...
  margin-left: -15px;
  margin-right: -15px;
  background: url("/img/core/poster-cartaz-super-mario-galaxy-2-game.jpg") top center no-repeat;
  ...
  .background-after {
    width: 100%;
    height: 75%;
    background-image: linear-gradient(transparent, rgba(10, 112, 253, 0.9), rgba(10, 112, 253, 1));
  }
}
